...
class RecommendationNotifierTest extends TestCase
{
    ...
    /** @var EzRecommendationClientInterface| \PHPUnit_Framework_MockObject_MockObject */
    private $clientMock;
    ...
    public function testUpdateContent()
    {
        ...
        /* Use Case */
        $notifier = new RecommendationNotifier(
            $this->clientMock,
