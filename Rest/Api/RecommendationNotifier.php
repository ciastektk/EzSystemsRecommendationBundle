...
class RecommendationNotifier extends AbstractApi
{
    ...
    /**
     * @param \EzSystems\RecommendationBundle\Client\EzRecommendationClientInterface
    ...
    public function updateContent($contentId, $versionNo = null)
    {
        ...
        $this->logger->debug(sprintf('RecommendationNotifier: Generating notification for updateContent(%s)', $content->id));
        ...
        try {
            ...
            $this->logger->error(sprintf('RecommendationNotifier: notification error for updateContent: %s', $e->getMessage()));
        }
    }
    ...
    public function deleteContent($contentId)
    {
        ...
        $this->logger->debug(sprintf('RecommendationNotifier: Generating notification for deleteContent(%s)', $content->id));
        ...
        try {
            ...
            $this->logger->error(sprintf('RecommendationNotifier: notification error for deleteContent: %s', $e->getMessage()));
        }
    }
    ...
    public function hideLocation($locationId, $isChild = false)
    {
        ...
        $this->logger->debug(sprintf('RecommendationNotifier: Generating notification for hide(%s)', $content->id));
        ...
        try {
            ...
            $this->logger->error(sprintf('RecommendationNotifier: notification error for hideLocation: %s', $e->getMessage()));
        }
    }
    ...
    public function unhideLocation($locationId)
    {
        ...
        $this->logger->debug(sprintf('RecommendationNotifier: Generating notification for unhide(%s)', $content->id));
        ...
        try {
            ...
            $this->logger->error(sprintf('RecommendationNotifier: notification error for unhideLocation: %s', $e->getMessage()));
        }
    }
